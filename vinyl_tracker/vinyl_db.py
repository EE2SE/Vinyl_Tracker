...
class VinylDBBase:
    ...
    def __init__(self, environment: str):
        ...
        self.__db_user = os.getenv(self.__db_user_varname) or self._raise_env_error(self.__db_user_varname)
        self.__db_password = os.getenv(self.__db_password_varname) or self._raise_env_error(self.__db_password_varname)
        self.__db_host = os.getenv(self.__db_host_varname) or self._raise_env_error(self.__db_host_varname)
        self.__db_port = os.getenv(self.__db_port_varname) or self._raise_env_error(self.__db_port_varname)
        self.__db_name = os.getenv(self.__db_name_varname) or self._raise_env_error(self.__db_name_varname)
